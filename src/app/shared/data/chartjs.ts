...
// PolarArea
export var polarAreaChartLabels: string[] = ['recebidos', 'entregues', 'expedidos', 'separadas'];
export var polarAreaChartData: number[] = [1000, 300, 600, 800];
export var polarAreaLegend = true;
export var ploarChartColors: any[] = [{ backgroundColor: ["rgba(24, 47, 179, 0.8)", "rgba(64, 189, 139, 0.8)", "rgba(255, 172, 27, 0.8)", "rgba(127, 147, 156, 0.8)"] }];
